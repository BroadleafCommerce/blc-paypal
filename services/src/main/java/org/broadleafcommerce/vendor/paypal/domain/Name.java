...
public class Name {
    ...
    public boolean equals(final java.lang.Object o) {
        ...
        if (this$given_name == null ? other$given_name != null
                : !this$given_name.equals(other$given_name))
            return false;
        ...
        if (this$middle_name == null ? other$middle_name != null
                : !this$middle_name.equals(other$middle_name))
            return false;
        ...
        if (this$alternate_full_name == null ? other$alternate_full_name != null
                : !this$alternate_full_name.equals(other$alternate_full_name))
            return false;
        final java.lang.Object this$full_name = this.getFull_name();
        final java.lang.Object other$full_name = other.getFull_name();
        if (this$full_name == null ? other$full_name != null
    ...
    public int hashCode() {
        ...
        result = result * PRIME
                + ($alternate_full_name == null ? 43 : $alternate_full_name.hashCode());
