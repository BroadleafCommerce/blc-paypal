...
public interface PayPalCheckoutConfiguration extends PaymentGatewayConfiguration {
    ...
    /**
     * For digital goods, this field is required and must be set to 1. 0 - PayPal displays the
     * shipping address passed in. 1 - PayPal does not display the shipping fields at all. (Default)
     ...
     * additionalConfigs.put("HDRBORDERCOLOR", "FFFFFF"); additionalConfigs.put("HDRBACKCOLOR",
     * "FFFFFF"); additionalConfigs.put("PAYFLOWCOLOR", "FFFFFF");
     * 
     * <p>
     * This adds additional NVP items to the Paypal request that are ONLY pre-specified in the
     * Paypal API docs. Any other fields will be ignored. If you want to use completely custom
     * fields, see {@link #getAdditionalCustomFields()}
     *
     * @return Map
     */
