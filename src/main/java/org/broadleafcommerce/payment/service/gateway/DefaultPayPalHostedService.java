...
public class DefaultPayPalHostedService extends AbstractPaymentGatewayHostedService
        implements PaymentGatewayHostedService {

    protected static final Log LOG = LogFactory.getLog(DefaultPayPalHostedService.class);
