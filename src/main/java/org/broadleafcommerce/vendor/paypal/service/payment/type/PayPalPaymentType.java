 ...
 * @author jfischer
 */
public class PayPalPaymentType implements Serializable, BroadleafEnumerationType {
    ...
    public PayPalPaymentType(final String type, final String friendlyType) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PayPalPaymentType other = (PayPalPaymentType) obj;
        if (type == null) {
            if (other.type != null)
                return false;
